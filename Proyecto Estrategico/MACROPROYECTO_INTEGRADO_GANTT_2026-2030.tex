...
% Header and footer (diseño sin branding)
\pagestyle{fancy}
\fancyhf{}
\fancyhead[C]{\textcolor{sadergris}{\footnotesize MACROPROYECTO RENACIMIENTO GANADERO MAYA - YUCATÁN 2026-2030}}
...
\textbf{\textcolor{sadergreen}{La Oportunidad:}} El Macroproyecto Estratégico Integrado ``Renacimiento Ganadero Maya 2026-2030'' representa una inversión optimizada de \textbf{\$818.0 millones de pesos} con esquema de financiamiento híbrido (\$651.3M subsidio tripartito + \$166.7M crédito productivo) que posiciona a Yucatán como el estado líder en ganadería climáticamente inteligente de México, generando beneficios económicos, ambientales y sociales mediante la integración eficiente de cinco componentes estratégicos: sistemas silvopastoriles intensivos, repoblamiento ganadero bovino, desarrollo lechero tropical, centro de mejoramiento genético, meliponicultura sustentable maya, y plataforma digital de seguimiento sanitario.
...
\textbf{\textcolor{sadergreen}{El Macroproyecto Integral:}} Este documento presenta la integración completa de cinco componentes estratégicos que constituyen un ecosistema tecnológico integral para la transformación agropecuaria de Yucatán:
\begin{itemize}
    \item \textbf{Componente 1: Sistemas Silvopastoriles Intensivos} --- 6,000 hectáreas con \textit{Leucaena leucocephala} (120 UPP) - \$334.4M (escenario recomendado \$55,733/ha)
...
\begin{itemize}
    ...
    \item \textbf{Estrategia Nacional de Mitigación:} Compromiso nacional ante COP26 y Acuerdo de París para reducir 30\% las emisiones de Gases de Efecto Invernadero del sector agropecuario al 2030 (línea base 2015). Incluye metas específicas: captura de carbono mediante sistemas silvopastoriles (50 millones toneladas CO$_2$eq), reducción de metano entérico vía mejoramiento genético y nutricional, y reconversión de 2 millones de hectáreas a sistemas sustentables
    \item \textbf{Plan Estatal de Desarrollo "Renacimiento Maya":} Plan Estatal de Desarrollo del Gobierno de Yucatán (2024-2030) que establece el marco estratégico para la transformación económica y social del estado. La Directriz 4.1.1 "Modernización del sector primario" prioriza la tecnificación agropecuaria mediante sistemas productivos sustentables, mejoramiento genético, fortalecimiento de cadenas de valor, y desarrollo de capacidades técnicas. Esta directriz incluye metas específicas para la ganadería: incremento de productividad, adopción de tecnologías sustentables, fortalecimiento de organizaciones productivas, y acceso a mercados especializados, alineándose con los objetivos de prosperidad compartida y rescate del campo yucateco.
    \item \textbf{PEF 2026 - Ramo 20 SADER:} El Presupuesto de Egresos de la Federación 2026, aprobado por el Congreso de la Unión, asigna \$109,456 millones de pesos al Ramo Administrativo 20 (Secretaría de Agricultura y Desarrollo Rural), representando un incremento real del 5.2\% respecto al ejercicio 2025. Este incremento refleja la priorización gubernamental del sector agropecuario como eje estratégico para la seguridad alimentaria nacional, el combate a la pobreza rural, y el cumplimiento de compromisos climáticos internacionales (COP26, T-MEC).
    \item \textbf{Recursos etiquetados ganadería sustentable:} Del presupuesto total SADER 2026, aproximadamente \$18,500 MDP (18\%) están específicamente etiquetados para programas de ganadería sustentable, incluyendo: reconversión productiva, sistemas silvopastoriles, mejoramiento genético, sanidad animal, trazabilidad (SINIIGA), y desarrollo de mercados. Esta etiquetación presupuestal garantiza que los recursos no pueden ser reasignados a otros sectores y están sujetos a indicadores específicos de impacto ambiental y productivo, alineados con la Estrategia Nacional de Mitigación de GEI.
\end{itemize}

\textbf{Programas federales específicos de concurrencia:}
\begin{itemize}
    \item \textbf{S304 - Fomento Agropecuario:} Programa presupuestario aprobado por el Congreso de la Unión con \$12,000 MDP totales, de los cuales {\textasciitilde}\$4,500 MDP están etiquetados para proyectos de ganadería sustentable. Opera mediante convenios de concertación con estados que aportan contrapartida mínima 25\%. Incluye subprogramas de reconversión productiva, tecnificación de sistemas ganaderos, y desarrollo de cadenas de valor.
    \item \textbf{Bienestar Pequeños y Medianos Ganaderos:} Programa social focalizado con \$6,500 MDP para productores con menos de 50 UA, operando vía Convenios de Coordinación estado-federación. Prioriza mujeres rurales, jóvenes, y pueblos indígenas. Incluye subsidios directos, asistencia técnica, y acceso a insumos básicos.
    \item \textbf{Crédito Ganadero a la Palabra:} Esquema de financiamiento rural sin garantías tradicionales con \$2,000 MDP integrado en S304. Dirigido a pequeños productores con historial crediticio limitado, tasas preferenciales 6-8\%, plazos hasta 7 años. Opera mediante ventanillas estatales y aval de organizaciones ganaderas.
    \item \textbf{SINIIGA/SINIDA:} Sistema Nacional de Identificación Individual de Ganado y Sistema Nacional de Información para el Desarrollo Rural Sustentable. Recursos específicos para implementar trazabilidad individual obligatoria, combate al abigeato mediante tecnología (aretes electrónicos, bases de datos), y fortalecimiento del padrón ganadero nacional.
    \item \textbf{Plan Binacional TB:} Programa México-Estados Unidos para erradicación de tuberculosis bovina, fundamentado en compromisos T-MEC. Incluye protocolos APHIS-USDA, certificación de predios libres, capacitación de médicos veterinarios, y habilitación para exportación de bovinos en pie y productos lácteos.
\end{itemize}
...
\textbf{Fundamento teórico - Principio de Pareto:} El economista italiano Vilfredo Pareto (1848-1923) demostró que en muchos fenómenos económicos y sociales, aproximadamente el 80\% de los efectos proviene del 20\% de las causas. Este principio, conocido como "regla 80/20", se aplica exitosamente en la focalización de políticas públicas para maximizar el impacto con recursos limitados.

\textbf{Aplicación en ganadería yucateca:} El Análisis de Pareto de la Concentración Ganadera por Organizaciones Regionales (Padrón Ganadero Nacional 2025) demuestra que \textbf{11 municipios (10.4\% del total de 106) concentran el 80.3\% de la actividad ganadera estatal}, incluyendo:
\begin{itemize}
    \item \textbf{80.3\% de la superficie ganadera} (810,713 ha de 1,299,200 ha totales)
    \item \textbf{80.1\% de los semovientes} (vientres + vaquillas + sementales = 188,512 de 235,267 cabezas)
    \item \textbf{79.7\% de las Unidades de Producción Pecuaria} (correlación directa con concentración territorial)
\end{itemize}

Esta concentración valida la aplicación del Principio de Pareto en la ganadería yucateca y fundamenta una estrategia de intervención altamente eficiente que permite atender más del 80\% de la actividad ganadera focalizando recursos en menos del 11\% del territorio estatal.
...
\begin{table}[H]
\centering
\caption{Regionalización de Inversiones del Macroproyecto (\$774.5 MDP)}
\footnotesize
...
\hline
\rowcolor{sadergold!30}
\textbf{TOTAL} & \textbf{100\%} & \textbf{100\%} & \textbf{\$818.0} & \textbf{Focalización Pareto} \\
\hline
\end{tabular}
\end{table}
...
\textbf{INVERSIÓN TOTAL:} \$818.0 millones de pesos (2026-2030)
\textbf{ESQUEMA FINANCIERO HÍBRIDO:} \$651.3M subsidio tripartito + \$166.7M crédito productivo SSPi
\textbf{ESTRUCTURA:} Cinco componentes estratégicos integrados (\$765.2M inversiones productivas + \$52.8M gastos operativos vía SEDER)
\begin{itemize}
    \item \textbf{Inversiones productivas:} \$765.2 millones (93.5\%)
...
\hline
\textbf{1. Sistemas Silvopastoriles Intensivos} & \$333.4 & 43.1\% & 120 & 6,000 hectáreas \\
\hline
Reconversión SSPi (\$55,573/ha) & \$333.4 & & & Leucaena + especies nativas \\
\textit{+ Crédito productivo} & \textit{\$166.7} & & & \textit{Ratio pago 4.0:1} \\
\hline
...
\hline
\textbf{5. Meliponicultura Sustentable} & \$42.5 & 5.6\% & 500 & Abejas sin aguijón Melipona \\
\hline
\textbf{6. Plataforma Digital Sanitaria} & \$8.5 & 1.1\% & 1,320 & Sistema CESO-APHIS \\
\hline
Desarrollo e implementación & \$8.5 & & & Integración T-MEC APIs \\
\hline
\rowcolor{sadergold!20}
\textbf{TOTAL INVERSIONES PRODUCTIVAS} & \textbf{\$756.9} & \textbf{97.7\%} & \textbf{1,320} & \textbf{Seis componentes} \\
\hline
\rowcolor{saderblue!15}
\textit{Gastos Operativos (5 años)} & \textit{\$17.6} & \textit{2.3\%} & \textit{--} & \textit{Jefe Programa + 4 staff SEDER} \\
\hline
\rowcolor{sadergreen!25}
\textbf{GRAN TOTAL MACROPROYECTO} & \textbf{\$774.5} & \textbf{--} & \textbf{1,320} & \textbf{2026-2030} \\
\hline
\end{tabular}
\end{table}
...
\hline
Semilla GUAJE (\textit{Leucaena leucocephala}) & 14 kg & \$800/kg & \$11,200 \\
\hline
Inoculante Rhizobium + micorrizas & 1 dosis & \$1,500/ha & \$1,500 \\
\hline
Plantas nativas mixtas (\textit{Brosimum}, \textit{Piscidia}, \textit{Guazuma}) & 55 plantas & \$18/planta & \$990 \\
\hline
...
\hline
\rowcolor{sadergold!30}
\multicolumn{3}{|l|}{\textbf{TOTAL PAQUETE TECNOLÓGICO}} & \textbf{\$55,733} \\
\hline
\end{tabular}
\end{table}

\textbf{Justificación técnica del paquete recomendado:} El costo de \$55,733/ha representa el escenario técnicamente recomendado basado en metodología científica validada por INIFAP-UADY-TNC (2015-2024) con especies nativas yucatecas certificadas. Este balance óptimo costo-eficiencia incluye siembra directa de \textit{Leucaena leucocephala} (6.0 kg/ha), densidades de 40,000-53,000 plantas/ha con fijación de nitrógeno de 250-550 kg/ha/año, 55 plantas nativas mixtas/ha (Ramón + Ja'abin + Pixoy), infraestructura de pastoreo racional completa, y establecimiento eficiente de especies forrajeras de alta calidad.\textsuperscript{4}
...
\textbf{Inversión total: \$870.8 millones de pesos (2026-2030)}

\textbf{Distribución de financiamiento federal PEF 2026:}
\begin{itemize}
    \item \textbf{Federal (60\% = \$364.7 MDP):} Programa Especial Concurrente para el Desarrollo Rural Sustentable (PECDRS)
    \begin{itemize}
        \item \textbf{S304 - Componente ganadero:} \$262.6 MDP (72\% del federal)
        \item \textbf{Bienestar Ganaderos:} \$72.9 MDP (20\% del federal)
        \item \textbf{Crédito a la Palabra:} \$29.2 MDP (8\% del federal)
    \end{itemize}
...
\textbf{Mecanismo SEDER Yucatán:} Los \$52.8 millones para gastos operativos constituyen un SUBSIDIO PÚBLICO para asistencia técnica que se ejecutará directamente por la Secretaría de Desarrollo Rural del Estado de Yucatán (SEDER), garantizando control estatal completo sobre la gestión técnica con un equipo de 5 profesionales especializados (1 Jefe de Programa + 4 staff técnico) durante los 5 años de implementación del macroproyecto. \textbf{ESTOS GASTOS NO SON CARGADOS A LOS PRODUCTORES} sino que representan la inversión pública en acompañamiento técnico especializado, separando claramente la rentabilidad privada de la inversión pública en extensionismo.
...
\begin{itemize}
    \item \textbf{Costo SSPi}: \$55,733/ha (escenario recomendado con especies nativas)
...
\begin{itemize}
    \item \textbf{Componente leguminoso intensivo}: GUAJE/HUAXIN (\textit{Leucaena leucocephala}) var. Cunningham (40,000-53,000 plantas/ha)
    ...
    \item \textbf{Componente arbóreo nativo}: RAMÓN (\textit{Brosimum alicastrum}), JABÍN (\textit{Piscidia piscipula}), GUÁCIMO (\textit{Guazuma ulmifolia}) (50 plantas/ha)
...
\hline
Semilla GUAJE (\textit{Leucaena leucocephala}) & 6.0 kg & \$180/kg & \$1,080 \\
\hline
Plantas nativas mixtas (Brosimum, Piscidia, Guazuma) & 55 plantas & \$18/planta & \$990 \\
\hline
...
\hline
\rowcolor{sadergold!30}
\multicolumn{3}{|l|}{\textbf{TOTAL POR HECTÁREA}} & \textbf{\$55,733} \\
\hline
\end{tabular}
...
Inversión total: \$334.4 MDP (2026-2030) - Escenario Recomendado \$55,733/ha
...
\begin{itemize}
    \item Polinización de especies forrajeras: GUAJE (\textit{Leucaena leucocephala}), GUÁCIMO (\textit{Guazuma ulmifolia})
...
\begin{itemize}
    \item \textbf{SSPi:} Presupuesto corregido a \$334.4M para meta 6,000 ha (\$55,733/ha paquete técnico recomendado con especies nativas). \textcolor{sadergreen}{\textbf{Esquema financiero híbrido:}} 50\% subsidio tripartito (\$167.2M) + 50\% crédito productivo FIRA (\$167.2M) con capacidad de pago validada 4.0:1 en modelo becerros al destete. Basado en evidencia empírica Chiapas: 1,078 ha/año promedio × 20 años. Meta Yucatán: 1,200 ha/año (11\% más ambicioso pero ALCANZABLE con esquema crediticio robusto y especies nativas certificadas)
...
\hline
\textbf{SSPi} & 6,000 ha convertidas, 120 UPP & \$334.4 & \$167.2 & \$83.6 & \$83.6 & \textcolor{red}{\textbf{50\% Crédito + 50\% Subsidio}} \\
\hline
...
\hline
\textbf{Digital} & 1,320 UPP certificadas, T-MEC & \$51.5 & \$30.9 & \$15.5 & \$5.1 & Conectividad + Capacitación \\
\hline
\textbf{Operación} & Equipo 5 personas × 5 años & \$52.8 & \$31.7 & \$15.8 & \$5.3 & Contraparte técnica \\
\hline
\rowcolor{sadergold!20}
\textbf{TOTALES} & \textbf{1,770 UPP + 500 melip.} & \textbf{\$870.8} & \textbf{\$489.1} & \textbf{\$243.6} & \textbf{\$138.2} & \textbf{\$166.7M crédito SSPi} \\
\hline
\multicolumn{7}{|p{16cm}|}{\footnotesize \textbf{Nota Crédito:} Del total \$138.2M de productores, \$166.7M son créditos formales del componente SSPi vía FIRA con 50\% financiamiento híbrido. Los \$138.2M incluyen aportaciones de productores (10\% esquema tripartito) en especie y efectivo. Créditos con tasa preferencial 6-8\%, plazo 7 años, garantía colectiva y capacidad de pago 4.0:1.} \\
\hline
\end{tabular}
\end{table}
...
\textbf{Estructura técnica optimizada del macroproyecto:} La ejecución simultánea de cinco componentes estratégicos integrados requiere un equipo técnico optimizado de 5 profesionales especializados (1 jefe de programa + 4 técnicos especializados) para garantizar la coordinación efectiva entre sistemas silvopastoriles, repoblamiento ganadero, desarrollo lechero, optimización genética, meliponicultura sustentable y plataforma sanitaria digital, generando un ahorro operativo de \$35.9 millones:
...
\begin{itemize}
    ...
    \item Ejecución de presupuesto tripartito de \$870.8 millones con rendición de cuentas
\end{itemize}
...
\hline
\rowcolor{sadergold!30}
\textbf{TOTAL} & \textbf{100\%} & \textbf{100\%} & \textbf{\$870.8} & \textbf{Macroproyecto Integral} \\
\hline
\end{tabular}
\end{table}
