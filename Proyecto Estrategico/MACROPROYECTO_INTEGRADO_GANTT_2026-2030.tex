...
\textbf{\textcolor{sadergreen}{La Oportunidad:}} El Macroproyecto Estratégico Integrado ``Renacimiento Ganadero Maya 2026-2030'' representa una inversión transformacional de \textbf{\$926.5 millones de pesos} que puede posicionar a Yucatán como el estado líder en ganadería climáticamente inteligente de México, generando beneficios económicos, ambientales y sociales sin precedentes mediante la integración de seis componentes estratégicos: sistemas silvopastoriles intensivos, repoblamiento ganadero bovino, desarrollo lechero tropical, centro de mejoramiento genético, planta de mosca estéril y certificación sanitaria binacional.
...
\begin{itemize}
    \item \textbf{Componente 1: Sistemas Silvopastoriles Intensivos} --- 6,000 hectáreas con \textit{Leucaena leucocephala} (120 UPP) - \$132.6M
    ...
    \item \textbf{Componente 5: Planta de Mosca Estéril (Screwworm)} --- Capacidad 250M moscas estériles/semana - \$300.0M
    \item \textbf{Componente 6: Certificación Sanitaria TBC + Digital} --- Protocolo T-MEC + plataforma CESO-APHIS - \$51.5M
\end{itemize}
...
\textbf{INVERSIÓN TOTAL:} \$926.5 millones de pesos (2026-2030)
\textbf{ESTRUCTURA:} Seis componentes estratégicos integrados (\$873.7M inversiones productivas + \$52.8M gastos operativos)
\begin{itemize}
...
\hline
\textbf{1. Sistemas Silvopastoriles Intensivos} & \$132.6 & 15.2\% & 120 & 6,000 hectáreas \\
\hline
Reconversión SSPi (\$12,100/ha) & \$72.6 & & & Leucaena + especies nativas \\
...
\hline
\textbf{4. Desarrollo Lechero Tropical} & \$89.5 & 10.2\% & 75 & +40\% producción \\
\hline
...
\hline
\textbf{5. Planta de Mosca Estéril (GBG)} & \$300.0 & 34.3\% & -- & Erradicación Screwworm \\
\hline
Laboratorio cría masiva & \$120.0 & & & 250M moscas/semana \\
Planta irradiación Co-60 & \$90.0 & & & Esterilización gamma \\
Flota aérea + operación & \$90.0 & & & Liberaciones aéreas \\
\hline
\textbf{6. Certificación TBC + Digital} & \$51.5 & 5.9\% & 1,075 & T-MEC compliance \\
\hline
Protocolo TBC binacional & \$34.7 & & & APHIS-USDA standards \\
Plataforma digital CESO & \$16.8 & & & Seguimiento acuerdos \\
\hline
\rowcolor{sadergold!20}
\textbf{TOTAL INVERSIONES PRODUCTIVAS} & \textbf{\$873.7} & \textbf{100\%} & \textbf{1,270} & \textbf{Seis componentes} \\
\hline
\rowcolor{saderblue!15}
\textit{Gastos Operativos (5 años)} & \textit{\$52.8} & \textit{5.7\%} & \textit{--} & \textit{Equipo técnico FOFAY} \\
\hline
\rowcolor{sadergreen!25}
\textbf{GRAN TOTAL MACROPROYECTO} & \textbf{\$926.5} & \textbf{--} & \textbf{1,270} & \textbf{2026-2030} \\
\hline
\end{tabular}
\end{table}
...
\textbf{Justificación técnica del paquete optimizado:} El costo de \$12,100/ha representa una inversión integral optimizada basada en metodología científica validada por INIFAP-UADY-TNC (2015-2024). La reducción de costos (34\% vs paquetes convencionales) se logra mediante siembra directa de \textit{Leucaena leucocephala} (6.0 kg/ha), que garantiza densidades de 40,000-53,000 plantas/ha con fijación de nitrógeno de 250-550 kg/ha/año, infraestructura de pastoreo racional optimizada, y establecimiento eficiente de especies forrajeras de alta calidad.\textsuperscript{4}
...
\subsection{Paquete Tecnológico Silvopastoril (\$12,100 MXN/hectárea)}
...
\hline
\rowcolor{sadergold!30}
\multicolumn{3}{|l|}{\textbf{TOTAL POR HECTÁREA}} & \textbf{\$12,100} \\
\hline
\end{tabular}
...
Inversión total: \$132.6 MDP (2026-2030)
...
\textbf{TOTAL COMPONENTE 1} & \textbf{132.6} & \textbf{79.6} & \textbf{39.8} & \textbf{13.3} \\
\hline
\end{tabular}
...
\begin{itemize}
    ...
    \item \textbf{Confirmación campo:} Barrido sanitario TBC revela discrepancias entre censo oficial y realidad predial
...
\section{Componente 5: Planta de Producción de Mosca Estéril}
...
\section{Componente 6: Certificación Sanitaria TBC + Seguimiento Digital}
...
\hline
SSPi (120 UPP) & 132.6 & 79.6 & 39.8 & 13.3 & 15.2\% \\
\hline
Repoblamiento Ganadero & 150.1 & 90.1 & 45.0 & 15.0 & 17.2\% \\
\hline
Centro Genético & 150.0 & 90.0 & 45.0 & 15.0 & 17.2\% \\
\hline
Lechería Tropical & 89.5 & 53.7 & 26.9 & 8.9 & 10.2\% \\
\hline
Planta Mosca Estéril & 300.0 & 180.0 & 90.0 & 30.0 & 34.3\% \\
\hline
Certificación TBC & 51.5 & 30.9 & 15.5 & 5.2 & 5.9\% \\
\hline
Gastos Operativos & 52.8 & 31.7 & 15.9 & 5.3 & 5.7\% \\
\hline
\rowcolor{sadergold!20}
\textbf{TOTAL} & \textbf{926.5} & \textbf{556.0} & \textbf{278.1} & \textbf{92.7} & \textbf{100\%} \\
\hline
...
\begin{itemize}
    \item \textbf{SSPi:} Presupuesto optimizado a \$132.6M para meta 6,000 ha (\$12,100/ha paquete técnico). Basado en evidencia empírica Chiapas: 1,078 ha/año promedio × 20 años. Meta Yucatán: 1,200 ha/año (11\% más ambicioso pero ALCANZABLE con continuidad institucional 10 años y metodología científicamente validada)
