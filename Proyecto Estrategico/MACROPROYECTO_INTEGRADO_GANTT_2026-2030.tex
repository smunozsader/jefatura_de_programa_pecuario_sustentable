...
\textbf{ESTRUCTURA:} Seis componentes estratégicos integrados (\$1,035.1M inversiones productivas + \$52.8M gastos operativos vía SEDER)
\begin{itemize}
...
\hline
\rowcolor{saderblue!15}
\textit{Gastos Operativos (5 años)} & \textit{\$52.8} & \textit{4.9\%} & \textit{--} & \textit{Jefe Programa + 4 staff SEDER} \\
\hline
\rowcolor{sadergreen!25}
\textbf{GRAN TOTAL MACROPROYECTO} & \textbf{\$1,087.9} & \textbf{--} & \textbf{1,320} & \textbf{2026-2030} \\
\hline
\end{tabular}
\end{table}
...
\textbf{Mecanismo SEDER Yucatán:} Los \$52.8 millones para gastos operativos se ejecutarán directamente por la Secretaría de Desarrollo Rural del Estado de Yucatán (SEDER), garantizando control estatal completo sobre la gestión técnica con un equipo de 5 profesionales especializados (1 Jefe de Programa + 4 staff técnico) durante los 5 años de implementación del macroproyecto.
