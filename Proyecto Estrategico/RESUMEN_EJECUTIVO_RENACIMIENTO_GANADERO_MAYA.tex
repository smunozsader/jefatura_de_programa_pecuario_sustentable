...
\fancyhead[C]{
  \begin{minipage}{\textwidth}
    ...
    \textcolor{sadergris}{\footnotesize RESUMEN EJECUTIVO - RENACIMIENTO GANADERO MAYA 2026-2030}
  \end{minipage}
}
...
{\Large\bfseries\color{sadergreen} \$1,050.1 MDP}\\[0.3cm]
...
Es precisamente en este contexto de transformación donde emerge el Macroproyecto Estratégico Integrado ``Renacimiento Ganadero Maya 2026-2030'', una iniciativa que trasciende la mera inversión de recursos para convertirse en la materialización de una visión de futuro. Con una inversión optimizada de \$1,050.1 millones de pesos, este proyecto no solo aspira a revitalizar la ganadería yucateca, sino a posicionar al estado como el referente nacional e internacional en ganadería climáticamente inteligente.
...
\textbf{Inversión Total Optimizada} & \textbf{\$1,050.1 MDP} \\
\hline
\end{tabular}
\end{table}
...
\begin{enumerate}
    ...
    \begin{itemize}
        \item UGROY (Oriente): 65\% de inversión (\$682.6 MDP)
        \item UGRY (Centro): 15\% de inversión (\$157.5 MDP)
        \item Reserva estratégica: 20\% (\$210.0 MDP)
    \end{itemize}
...
\hline
\rowcolor{sadergold!20}
\textbf{SUBTOTAL INVERSIONES PRODUCTIVAS} & \textbf{\$1,033.2} & \textbf{98.4\%} \\
\hline
\rowcolor{saderblue!15}
\textbf{GASTOS OPERATIVOS (5 años)} & & \\
\quad Equipo técnico OREF Yucatán (5 personas) & \textbf{\$16.9} & \textbf{1.6\%} \\
\hline
\rowcolor{sadergreen!30}
\textbf{GRAN TOTAL MACROPROYECTO} & \textbf{\$1,050.1} & \textbf{100.0\%} \\
\hline
\end{tabular}
\end{table}
...
\begin{itemize}
    \item \textbf{Subsidio Tripartito:} \$883.4 MDP (60\% Federal \$530.0M + 30\% Estatal \$265.0M + 10\% Productores \$88.3M)
    \item \textbf{Crédito Productivo SSPi:} \$166.7 MDP (50\% del componente SSPi, ratio pago 4.0:1)
    \item \textbf{Total movilizado:} \$1,050.1 MDP
\end{itemize}
