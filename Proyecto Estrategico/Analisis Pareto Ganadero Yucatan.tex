...
\geometry{top=2.5cm,bottom=2.5cm,left=3cm,right=3cm,headheight=70pt}
...
\fancyhead[C]{
  \begin{minipage}{\textwidth}
    ...
    \textcolor{sadergris}{\footnotesize ANÁLISIS DE PARETO - CONCENTRACIÓN GANADERA YUCATÁN}
  \end{minipage}
}
...
\author{Gobierno del Estado de Yucatán - SEDER\\
MVZ Sergio Muñoz de Alba Medrano, Consultor Independiente\\
Basado en Padrón Ganadero Nacional 2025}
\date{Noviembre 2025}
