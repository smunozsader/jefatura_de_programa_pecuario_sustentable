...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[C]{\textcolor{sadergris}{\small MEMORIA DE CÁLCULO - PAQUETE TECNOLÓGICO SILVOPASTORIL}}
...
\begin{itemize}
    \item \textbf{Semillas por kilogramo:} 1,800,000 semillas/kg
    \item \textbf{Poder germinativo:} 75\% (certificada)
    \item \textbf{Densidad objetivo:} 300 plantas/m² = 3,000,000 plantas/ha
    \item \textbf{Factor de seguridad:} 1.3 (considera mortalidad establecimiento)
\end{itemize}
...
\hline
\textit{Cynodon nlemfuensis} & 3.0 & \$250 & \$750 & Casa Jiménez SA \\
\hline
