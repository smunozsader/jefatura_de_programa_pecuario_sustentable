...
\fancyhead[C]{
  \begin{minipage}{\textwidth}
    ...
    \textcolor{sadergreen}{\footnotesize RECÁLCULO MACROPROYECTO RENACIMIENTO GANADERO MAYA}
  \end{minipage}
}
\rfoot{\thepage}
...
\author{MVZ Sergio Muñoz de Alba Medrano\\Consultor Independiente - SEDER Yucatán}
\date{Diciembre 2025}
