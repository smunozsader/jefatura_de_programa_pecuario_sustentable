...
% Header con logo banner Yucatán
\pagestyle{fancy}
\fancyhf{}
\fancyhead[C]{
  \begin{minipage}{\textwidth}
    ...
    \textcolor{sadergreen}{\footnotesize ANEXO TÉCNICO SILVOPASTORIL - YUCATÁN 2026-2030}
  \end{minipage}
}
\rfoot{\thepage}
...
\begin{titlepage}
    ...
    \vspace{0.4cm}
    {\normalsize\bfseries Anexo Técnico A:\par}
    \vspace{0.6cm}
    
    {\LARGE\bfseries SISTEMAS SILVOPASTORILES INTENSIVOS\par}
    \vspace{0.8cm}
    {\Large Metodologías, Protocolos y Especificaciones Técnicas\par}
    \vspace{0.3cm}
    {\normalsize Macroproyecto Renacimiento Ganadero Maya 2026-2030\par}
    \vspace{0.5cm}
...
\section{A.1 Paquete Tecnológico Silvopastoril Optimizado}

\subsection{Desglose Técnico-Económico (\$55,573 MXN/hectárea)}

El paquete tecnológico silvopastoril representa la síntesis de dos décadas de investigación aplicada en sistemas agroforestales tropicales, optimizado específicamente para las condiciones edafoclimáticas de Yucatán. El escenario recomendado de \$55,573/ha logra el balance óptimo entre viabilidad técnica y eficiencia económica, incorporando infraestructura de pastoreo racional completa y sistemas de alta productividad validados científicamente.
...
\textbf{Componente} & \textbf{Unidad} & \textbf{Costo Unit.} & \textbf{Costo/ha} & \textbf{\% del Total} \\
\hline
...
\textbf{Subtotal Pastos} & & & \textbf{\$2,030} & \textbf{16.8\%} \\
\hline
...
\hline
Cercos eléctricos & 1,000 m & \$40/m & \$15,000 & 27.0\% \\
\hline
Bebederos móviles & 4 unidades & \$1,500/unidad & \$6,000 & 10.8\% \\
\hline
Sistema de agua & 150 m tubería & \$167/m & \$25,000 & 45.0\% \\
\hline
\rowcolor{saderblue!10}
\textbf{Subtotal Infraestructura} & & & \textbf{\$46,000} & \textbf{82.8\%} \\
\hline
\multicolumn{5}{|l|}{\textbf{Insumos Biológicos y Capacitación}} \\
\hline
Biofertilizantes & 0.5 ton & \$800/ton & \$400 & 3.3\% \\
\hline
...
\hline
\rowcolor{saderblue!10}
\textbf{Subtotal Biológico} & & & \textbf{\$2,050} & \textbf{16.9\%} \\
\hline
\rowcolor{sadergold!30}
\multicolumn{3}{|l|}{\textbf{TOTAL PAQUETE TECNOLÓGICO}} & \textbf{\$55,573} & \textbf{100.0\%} \\
\hline
\end{tabular}
\caption{Desglose Detallado del Paquete Silvopastoril Optimizado}
\end{table}

\textbf{Memoria de cálculo técnico:}
\begin{itemize}
    \item \textbf{Densidad Leucaena:} 6.0 kg/ha × 18,000 semillas/kg × 85\% germinación × 90\% supervivencia = 82,620 plantas establecidas/ha
    \item \textbf{Espaciamiento efectivo:} Siembra directa múltiple en sistema 3×3 metros permite 40,000-53,000 plantas/ha operativas
    \item \textbf{Fijación de N\textsubscript{2}:} 250-550 kg N/ha/año validado por INIFAP-UADY en suelos kársticos yucatecos
    \item \textbf{Balance costo-eficiencia:} Escenario técnicamente recomendado que maximiza productividad (3.5-4.0 UA/ha) con viabilidad económica demostrada
\end{itemize}

\section{A.2 Metodología Escuelas de Campo Silvopastoriles}
...
\textbf{Principios andragógicos fundamentales para educación de adultos:}
\begin{itemize}
...
\subsection{A.3 Marco Metodológico TNC-UADY para Innovación Ganadera}

\textbf{Fundamentos del modelo participativo:}
...
\textbf{Principios rectores del modelo TNC-UADY:}

\begin{enumerate}
    \item \textbf{Co-innovación multi-actor:} Productores, investigadores, técnicos y actores de mercado como co-diseñadores del proceso de innovación
    \item \textbf{Aprendizaje social adaptativo:} Construcción colectiva de conocimiento mediante experimentación participativa y reflexión crítica
    \item \textbf{Escalamiento horizontal:} Difusión campesino-a-campesino basada en redes de confianza y legitimidad social
    \item \textbf{Institucionalización progresiva:} Incorporación gradual en políticas públicas, programas educativos y marcos normativos
\end{enumerate}

\textbf{Metodología de Escuelas de Campo Adaptada Colombia-México:}

La experiencia colombiana en sistemas silvopastoriles (CIPAV, CIAT, 1995-2020) aporta metodologías andragógicas validadas para educación de adultos rurales en contextos tropicales similares a Yucatán. Las adaptaciones metodológicas para aprendizaje adulto incluyen:

\begin{itemize}
    \item \textbf{Diagnóstico rural participativo:} Mapeo de activos, análisis de problemas, identificación de oportunidades mediante técnicas vivenciales
    \item \textbf{Parcelas de aprendizaje:} Establecimiento de módulos demostrativos en predios de productores líderes con manejo comparativo
    \item \textbf{Intercambios horizontales:} Giras técnicas, pasantías, encuentros regionales para validación cruzada de experiencias
    \item \textbf{Sistematización participativa:} Documentación colectiva de lecciones aprendidas, ajustes tecnológicos, indicadores de impacto
\end{itemize}

\subsection{A.4 El Largo y Sinuoso Camino: Lecciones de Masificación SSPi}
...
\textbf{6. Integración del conocimiento tradicional maya y validación científica}

Los sistemas silvopastoriles más exitosos en la Península de Yucatán han surgido de la síntesis entre conocimientos mayas ancestrales y validación científica contemporánea. Las especies nativas como Ja'abin (\textit{Piscidia piscipula}), Ramón (\textit{Brosimum alicastrum}), y Pixoy (\textit{Guazuma ulmifolia}) formaban parte de sistemas agroforestales tradicionales que fueron \"redescubiertos\" y optimizados mediante investigación participativa UADY-TNC.

Esta integración requiere metodologías específicas de diálogo de saberes que reconozcan la legitimidad tanto del conocimiento campesino como del conocimiento científico, evitando relaciones extractivas donde los investigadores simplemente \"validan\" prácticas tradicionales sin reconocer la autoría intelectual de las comunidades.

\textbf{7. De proyectos piloto a políticas públicas masivas}

La transición de proyectos piloto exitosos a políticas públicas masivas constituye el mayor desafío para la adopción masiva de SSPi. Los casos exitosos (Costa Rica, Colombia, Brasil) han logrado esta transición mediante: (a) articulación de evidencia científica sólida con demandas sociales organizadas, (b) construcción de coaliciones amplias que incluyan sector productivo, academia, organizaciones civiles, (c) diseño de instrumentos de política flexibles que se adapten a diversidades regionales, y (d) formación de capacidades institucionales para implementación a gran escala. 

El Macroproyecto Renacimiento Ganadero Maya incorpora estas lecciones mediante: continuidad institucional de 10 años, presupuesto robusto (\$926.5 MDP), metodología ECA validada, y articulación federal-estatal-productores con marco normativo específico.
