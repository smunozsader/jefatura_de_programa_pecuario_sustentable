...
\fancyhead[C]{
  \begin{minipage}{\textwidth}
    ...
    \textcolor{sadergris}{\footnotesize PITCH EJECUTIVO - RENACIMIENTO GANADERO MAYA 2026-2030}
  \end{minipage}
}
...
\includegraphics[width=0.4\textwidth]{logo yucatan.jpg}\\[0.6cm]

{\large\bfseries\color{sadergreen} Gobierno del Estado de Yucatán}\\[0.1cm]
{\normalsize\bfseries Secretaría de Desarrollo Rural (SEDER)}\\[0.4cm]

{\small\textbf{Preparado por:}}\\[0.05cm]
{\small MVZ Sergio Muñoz de Alba Medrano}\\[0.05cm]
{\small Consultor Independiente - Encargo SEDER}\\[0.2cm]
...
\textbf{GRAN TOTAL} & \textbf{\$1,050.1} & \textbf{100.0\%} \\
\hline
\end{tabular}
\end{table}
