...
% Header con logo banner Yucatán-SEDER
\fancyhead[C]{
  \begin{minipage}{\textwidth}
    \centering
    \includegraphics[width=0.6\textwidth]{logo yucatan.jpg}\\[0.05cm]
    \textcolor{sadergris}{\footnotesize PROYECTO ESTRATÉGICO SILVOPASTORIL YUCATÁN 2026-2030}
  \end{minipage}
}
...
\begin{titlepage}
    ...
    \vspace{0.5cm}
    {\large\bfseries\color{sadergreen} Gobierno del Estado de Yucatán\par}
    {\large Secretaría de Desarrollo Rural (SEDER)\par}
    \vspace{0.5cm}
    {\large\textbf{Preparado por:}\par}
    {\large MVZ Sergio Muñoz de Alba Medrano\par}
    {\large Consultor Independiente\par}
    {\large\textit{Encargo Especial - SEDER Yucatán}\par}
\end{titlepage}
