...
\begin{itemize}
    ...
    \item \textbf{Co-beneficios}: Captura carbono (15 ton CO₂eq/ha), biodiversidad, sombra para vacas lecheras
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Servicios ecosistémicos}: 16,875 ton CO₂eq capturadas (1,125 ha × 15 ton/ha)
