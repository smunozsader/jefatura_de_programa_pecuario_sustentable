...
\subsection{Impactos Productivos (2030)}

\begin{itemize}
    \item \textbf{Incremento del hato}: 14,544 cabezas (12,000 introducidas + 2,544 crías) = +2.4\% del inventario estatal
    \item \textbf{Mejora productividad cárnica}: 15-20\% por animal (200 kg → 230-240 kg peso vivo)
    \item \textbf{Aumento producción láctea}: 2-3 L/vaca/día adicionales en sistema doble propósito
