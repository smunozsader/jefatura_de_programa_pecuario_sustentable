...
% Todos los logos removidos de la portada según instrucciones
\vspace{0.3cm}
...
{\tiny SADER-SENASICA + SEDER Yucatán + SSY + UADY + OIEA + CPA (Comisión México-EUA para Prevención de Enfermedades Exóticas)}\\[0.4cm]

{\small\textbf{Objetivo Estratégico:}}\\[0.1cm]
{\footnotesize\bfseries Erradicación definitiva del Gusano Barrenador del Ganado (GBG)\\
mediante Técnica del Insecto Estéril con inicio operativo para el Tercer trimestre de 2026\\
...
Este proyecto estratégico responde a la emergencia sanitaria derivada de brotes activos de Gusano Barrenador del Ganado (\textit{Cochliomyia hominivorax}) detectados a fines de 2024, que resultaron en la suspensión de exportaciones ganaderas a Estados Unidos implementada a inicios de 2025\textsuperscript{15,19}. Los datos del modelo de implementación de Chiapas demuestran capacidad de producción exitosa superior a 4,000 millones de moscas estériles liberadas\textsuperscript{13,5}, respaldando la factibilidad de implementación acelerada en Yucatán con inicio operativo proyectado para el Tercer trimestre de 2026.

\textbf{Análisis de Situación Actual:}
\begin{itemize}
    \item \textbf{Evaluación de impacto económico:} Pérdidas anuales cuantificadas de \$50 millones USD en exportaciones\textsuperscript{2,20}
    \item \textbf{Evaluación de infraestructura:} Capacidad operativa verificada en instalaciones SSY, UADY y SEDER
    \item \textbf{Validación del modelo:} Instalación de Chiapas alcanzando producción de 100M moscas/semana en cronograma de 18 meses\textsuperscript{13,5}
    \item \textbf{Marco de cooperación internacional:} Protocolos de asistencia técnica APHIS-USDA establecidos\textsuperscript{15,19}
\end{itemize}

\textbf{Colaboración Binacional vía CPA:} Bajo el marco de la CPA (integrando SENASICA y APHIS-USDA), se habilitan protocolos conjuntos para erradicación GBG, incluyendo transferencia tecnológica y recursos extraordinarios para contención transfronteriza (brotes 2024-2025).
...
\begin{itemize}
    ...
    \item Cumplimiento con estándares CPA para dosis controlada, asegurando compatibilidad binacional
\end{itemize}
...
\textbf{Indicadores Binacionales CPA:}
\begin{itemize}
    \item \textbf{Colaboración transfronteriza:} Número de protocolos conjuntos implementados (meta: 5 por año)
    \item \textbf{Reducción riesgos:} \% disminución en alertas GBG fronterizas (meta: 80\% por 2028)
\end{itemize}
...
\hline
\textbf{CPA (Comisión México-EUA)} & \textbf{Marco binacional para erradicación exóticas} \\
\textit{(Cooperación internacional)} & • Vigilancia transfronteriza y alertas tempranas (e.g., datos Veracruz/Chiapas) \\
& • Protocolos conjuntos SENASICA-APHIS para TIE y certificación OIE \\
& • Recursos compartidos para producción estéril (e.g., asistencia USDA) \\
& • Integración con T-MEC para trazabilidad SINIIGA en exportaciones \\
\hline
...
Esta capacidad inicial permitirá implementar tratamientos focalizados mientras se desarrolla la infraestructura de gran escala con tecnología Cobalto-60\textsuperscript{3,1}.
...
El Gusano Barrenador del Ganado (\textit{Cochliomyia hominivorax}) constituye la principal limitante sanitaria para el desarrollo ganadero sustentable en la región sureste de México. Este parásito obligatorio causa pérdidas económicas estimadas en \$50 millones USD anuales en la Península de Yucatán, representando el 8.2\% del valor de la producción ganadera regional\textsuperscript{2,20}.

\textbf{Impacto económico documentado:}
\begin{itemize}
    \item \textbf{Mortalidad en ganado infestado:} 8-12\% en animales no tratados\textsuperscript{1,10}
    \item \textbf{Pérdidas productivas:} Reducción 15-25\% ganancia de peso por estrés y trauma\textsuperscript{2,1}
    \item \textbf{Costos de tratamiento:} \$200-350 pesos por animal (medicamentos + mano de obra)\textsuperscript{10,12}
    \item \textbf{Restricciones comerciales:} Prohibición exportación a mercados T-MEC libres de GBG\textsuperscript{16,11}
\end{itemize}
...
La Técnica del Insecto Estéril representa la metodología de control biológico más eficaz para la erradicación de artrópodos plaga de importancia económica y sanitaria\textsuperscript{4,2}. Desarrollada bajo los auspicios del Organismo Internacional de Energía Atómica (OIEA), esta tecnología ha demostrado efectividad cuantificable en lograr la eliminación definitiva de poblaciones de GBG en múltiples regiones geográficas a nivel mundial\textsuperscript{21,20}.

\textbf{Principios científicos fundamentales:}

\textbf{1. Protocolos de cría masiva en laboratorio}
\begin{itemize}
    \item Mantenimiento de colonias parentales con índices de diversidad genética controlada\textsuperscript{5,3}
    \item Composición estandarizada de dieta artificial (40\% sangre bovina, 20\% caseína, 5\% agar, vitaminas)\textsuperscript{5,3}
    \item Parámetros ambientales controlados (27±1°C temperatura, 60±10\% HR, fotoperíodo 12:12 L:O)\textsuperscript{3,12}
    \item Protocolos de aseguramiento de calidad genética manteniendo aptitud reproductiva\textsuperscript{5,2}
\end{itemize}

\textbf{2. Protocolos de esterilización por radiación gamma}
\begin{itemize}
    \item Irradiación gamma de pupas masculinas utilizando fuentes de Cobalto-60\textsuperscript{4,1}
    \item Dosis controlada de 60-90 Gray logrando esterilidad $\geq$99\%\textsuperscript{4,5}
    \item Mantenimiento de parámetros de competitividad sexual post-irradiación\textsuperscript{4,12}
    \item Preservación de capacidades de vuelo y comportamiento de apareamiento\textsuperscript{4,5}
\end{itemize}

\textbf{3. Metodología de liberación terrestre sistemática}
\begin{itemize}
    \item Densidad de liberación estandarizada: 3,000-5,000 machos estériles por km²\textsuperscript{13,4}
    \item Cronograma de liberación: 3-4 eventos por semana con distribución georreferenciada\textsuperscript{6,7}
    \item Proporción objetivo de sobrecruzamiento: 10:1 machos estériles/machos silvestres\textsuperscript{13,2}
    \item Protocolos de monitoreo utilizando trampas específicas y análisis estadístico poblacional\textsuperscript{6,18}
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Resultados:} Erradicación exitosa hasta el Istmo de Tehuantepec\textsuperscript{2,17}
...
\begin{itemize}
    \item \textbf{Estructura:} Concreto armado con aislamiento térmico especializado\textsuperscript{5,13}
    \item \textbf{Distribución:} 12 módulos de producción + áreas de apoyo\textsuperscript{5,18}
    \item \textbf{Sistemas de clima:} HVAC con control automatizado ±1°C, ±5\% HR\textsuperscript{5,14}
...
\begin{itemize}
    \item 50 jaulas de mantenimiento (80×60×60 cm) con malla antiáfidos\textsuperscript{5,18}
...
\textbf{Fase Inicial - Implementación Acelerada (Primer-Tercer Trimestre 2026)}
...
\subsection{Cronograma de Implementación Acelerada}
...
\begin{itemize}
    \item \textbf{Primer-Segundo Trimestre 2027:} Construcción biofábrica definitiva + instalación Cobalto-60
    \item \textbf{Tercer-Cuarto Trimestre 2027:} Capacidad plena 100M moscas/semana + flota aérea
...
\begin{itemize}
    ...
    \item \textbf{T2:} Inicio de liberaciones piloto controladas en zona norte de Yucatán\textsuperscript{19,13}
...
\subsection{Cronograma Crítico 2026 - Respuesta Sanitaria}

\begin{table}[H]
\centering
\caption{Cronograma Mensual 2026 - Liberaciones Tercer Trimestre}
\footnotesize
...
\textbf{Período} & \textbf{1er Trim-2026} & \textbf{2do Trim-2026} & \textbf{3er Trim-2026} & \textbf{4to Trim-2026} \\
\hline
...
\textbf{Riesgo 3: Riesgo Binacional - Demoras en certificación APHIS}
\begin{itemize}
    \item \textbf{Descripción:} Retrasos en validación conjunta SENASICA-APHIS vía CPA
    \item \textbf{Probabilidad:} Media (25\%)
    \item \textbf{Impacto:} Alto - Postergación de liberaciones operativas
    \item \textbf{Mitigación:} Integración vía CPA con reuniones ejecutivas trimestrales SENASICA-CPA
    \item \textbf{Responsabilidad:} SENASICA + CPA
\end{itemize}
...
\textbf{Acciones inmediatas (Primer Trimestre 2026):}
\begin{enumerate}
...
\item SENASICA-CPA. (2025). \textit{Protocolos Binacionales para Erradicación del Gusano Barrenador del Ganado}. Comisión México-Estados Unidos para la Prevención de Enfermedades Exóticas de los Animales. México.
...
\item USDA-APHIS \& SENASICA. (2025). \textit{Actualización sobre Esfuerzos Conjuntos para la Erradicación del Gusano Barrenador}. Washington, D.C.
