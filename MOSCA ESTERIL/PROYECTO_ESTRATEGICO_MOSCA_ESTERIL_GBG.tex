...
{\Large\bfseries\color{sadergreen} PROYECTO ESTRATÉGICO}\\[0.3cm]
{\large\bfseries PLANTA DE PRODUCCIÓN DE MOSCA ESTÉRIL}\\[0.2cm]
{\normalsize\bfseries Erradicación del Gusano Barrenador del Ganado}\\[0.15cm]
{\normalsize\bfseries Estado de Yucatán, México}\\[0.15cm]
{\small 2026-2030}\\[0.8cm]

% Logos institucionales balanceados
\begin{center}
\includegraphics[width=0.6\textwidth]{logo yucatan.jpg}\\[0.3cm]
...
{\footnotesize Oficina de Representación en la Entidad Federativa Yucatán (OREF)}\\[0.2cm]

{\small\bfseries Gobierno del Estado de Yucatán}\\[0.05cm]
{\footnotesize Secretaría de Desarrollo Rural (SEDER)}\\[0.05cm]
{\footnotesize Servicios de Salud de Yucatán (SSY)}\\[0.2cm]

{\small\bfseries Colaboración Técnica Internacional}\\[0.05cm]
{\footnotesize Universidad Autónoma de Yucatán (UADY)}\\[0.05cm]
{\footnotesize Programa Nacional de Control del Gusano Barrenador del Ganado}\\[0.6cm]

{\normalsize\textbf{Inversión Total:}}\\[0.15cm]
{\large\bfseries\color{sadergreen} \$210.0 MDP}\\[0.3cm]
{\footnotesize Esquema de Colaboración Interinstitucional}\\[0.1cm]
{\tiny SADER-SENASICA + SEDER Yucatán + SSY + UADY + OIEA}\\[0.6cm]

{\small\textbf{Objetivo Estratégico:}}\\[0.2cm]
...
con liberaciones terrestres y capacidad de 100 millones moscas estériles/semana}\\[0.8cm]

{\small\textbf{Elaborado por:}}\\[0.1cm]
{\footnotesize MVZ Sergio Muñoz de Alba Medrano}\\[0.05cm]
{\footnotesize Consultor Independiente}\\[0.3cm]
