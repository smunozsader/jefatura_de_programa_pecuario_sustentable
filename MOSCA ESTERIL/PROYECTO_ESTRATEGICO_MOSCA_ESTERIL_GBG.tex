...
{\LARGE\bfseries\color{sadergreen} PROYECTO ESTRATÉGICO}\\[0.4cm]
{\Large\bfseries PLANTA DE PRODUCCIÓN DE MOSCA ESTÉRIL}\\[0.3cm]
{\large\bfseries Erradicación del Gusano Barrenador del Ganado}\\[0.2cm]
{\large\bfseries Estado de Yucatán, México}\\[0.2cm]
{\normalsize 2026-2030}\\[1cm]

% Logos institucionales balanceados
\begin{center}
\includegraphics[width=0.7\textwidth]{logo yucatan.jpg}\\[0.5cm]
\includegraphics[width=0.35\textwidth]{logo_sader.png}
\end{center}
\vspace{0.8cm}

{\normalsize\bfseries Secretaría de Agricultura y Desarrollo Rural}\\[0.1cm]
{\small Servicio Nacional de Sanidad, Inocuidad y Calidad Agroalimentaria}\\[0.1cm]
{\small Oficina de Representación en la Entidad Federativa Yucatán (OREF)}\\[0.3cm]

{\normalsize\bfseries Gobierno del Estado de Yucatán}\\[0.1cm]
{\small Secretaría de Desarrollo Rural (SEDER)}\\[0.1cm]
{\small Servicios de Salud de Yucatán (SSY)}\\[0.3cm]

{\normalsize\bfseries Colaboración Técnica Internacional}\\[0.1cm]
{\small Universidad Autónoma de Yucatán (UADY)}\\[0.1cm]
{\small Programa Nacional de Control del Gusano Barrenador del Ganado}\\[1cm]

{\large\textbf{Inversión Total:}}\\[0.2cm]
{\Large\bfseries\color{sadergreen} \$210.0 MDP}\\[0.4cm]
{\small Esquema de Colaboración Interinstitucional}\\[0.2cm]
{\footnotesize SADER-SENASICA + SEDER Yucatán + SSY + UADY + OIEA}\\[1cm]

{\normalsize\textbf{Objetivo Estratégico:}}\\[0.3cm]
{\small\bfseries Erradicación definitiva del Gusano Barrenador del Ganado (GBG)\\
mediante Técnica del Insecto Estéril con \textcolor{red}{\textbf{INICIO Q3-2026}}\\
con liberaciones terrestres y capacidad de 100 millones moscas estériles/semana}\\[1.2cm]
...
{\small OREF Yucatán - SADER}\\[0.6cm]
...
\begin{itemize}
    \item \textbf{Mortalidad directa:} 15-25\% en becerros menores de 6 meses
    \item \textbf{Pérdidas productivas:} Reducción 30-40\% ganancia de peso
    \item \textbf{Costos veterinarios:} \$180-250 pesos por animal tratado
    \item \textbf{Restricciones comerciales:} Prohibición exportación a mercados libres de GBG
\end{itemize}
...
\begin{itemize}
    \item Código Sanitario para los Animales Terrestres
    \item Procedimientos para reconocimiento de zonas libres de enfermedades
    \item Requisitos de vigilancia epidemiológica activa y pasiva
\end{itemize}

\textbf{3. Servicio de Inspección Sanitaria de Animales y Plantas (APHIS-USDA)}
\begin{itemize}
    \item Protocolo binacional México-EEUU para control de GBG
    \item Requerimientos técnicos para certificación de plantas de mosca estéril
    \item Estándares de calidad para liberaciones masivas
\end{itemize}
...
La Técnica del Insecto Estéril constituye el método de control biológico más eficaz para la erradicación de plagas de importancia económica y sanitaria. Desarrollada por el Organismo Internacional de Energía Atómica (OIEA), esta tecnología ha demostrado su efectividad en la eliminación definitiva del GBG en múltiples regiones del mundo.

\textbf{Principios científicos fundamentales:}

\textbf{1. Cría masiva en laboratorio}
\begin{itemize}
    \item Mantenimiento de colonias parentales con diversidad genética controlada
    \item Dieta artificial optimizada (sangre bovina, caseína, agar, vitaminas)
    \item Condiciones ambientales estandarizadas (temperatura, humedad, fotoperíodo)
    \item Control de calidad genético para mantener vigor reproductivo
\end{itemize}

\textbf{2. Esterilización por radiación gamma}
\begin{itemize}
    \item Irradiación de pupas masculinas con Cobalto-60
    \item Dosis óptima: 60-90 Gray para esterilidad $\geq$99\%
    \item Preservación de capacidad de vuelo y apareamiento
    \item Competitividad sexual mantenida post-irradiación
\end{itemize}
...
\textbf{Estados Unidos - Programa Nacional (1958-1982)}
\begin{itemize}
    \item \textbf{Superficie erradicada:} 2.5 millones km² (sureste estadounidense)
    \item \textbf{Inversión total:} \$750 millones USD (valores ajustados 2025)
    \item \textbf{Beneficio-costo:} Ratio 30:1 en 20 años post-erradicación
    \item \textbf{Status actual:} Zona libre mantenida desde 1982
\end{itemize}

\textbf{México - Programa Nacional (1976-2006)}
\begin{itemize}
    \item \textbf{Superficie erradicada:} 1.8 millones km² (centro y norte de México)
    \item \textbf{Plantas operativas:} Tuxtla Gutiérrez (1976-2006), Tapachula (barrera biológica)
    \item \textbf{Resultados:} Erradicación exitosa hasta el Istmo de Tehuantepec
    \item \textbf{Beneficios económicos:} \$2,500 millones USD en 30 años
\end{itemize}
...
\begin{itemize}
    \item \textbf{Estructura:} Concreto armado con aislamiento térmico especializado
    \item \textbf{Distribución:} 12 módulos de producción + áreas de apoyo
    \item \textbf{Sistemas de clima:} HVAC con control automatizado ±1°C, ±5\% HR
    \item \textbf{Filtración:} Sistemas HEPA para prevención de contaminación cruzada
    \item \textbf{Seguridad biológica:} Nivel BSL-1 con protocolos de cuarentena
\end{itemize}
...
\begin{itemize}
    \item 50 jaulas de mantenimiento (80×60×60 cm) con malla antiáfidos
    \item Sistema de alimentación automatizado para adultos (miel + agua)
    \item Control reproductivo con 500 hembras y 200 machos por jaula
    \item Renovación genética trimestral con material silvestre certificado
\end{itemize}

\textbf{2. Sala de Oviposición (300 m²)}
\begin{itemize}
    \item 100 dispositivos de oviposición con carne fresca estimulante
    \item Sistema de recolección de huevos cada 6 horas
    \item Tratamiento superficial con hipoclorito de sodio 0.5\%
    \item Capacidad: 50 millones de huevos por semana
\end{itemize}
...
\begin{itemize}
    \item \textbf{Actividad inicial:} 37 PBq (1,000 Curios)
    \item \textbf{Configuración:} Fuente tipo lápiz en arreglo hexagonal
    \item \textbf{Vida útil:} 15 años con recarga programada cada 10 años
    \item \textbf{Tasa de dosis:} 2,000 Gy/hora a 30 cm de distancia
\end{itemize}

\textbf{Sistema de irradiación}
\begin{itemize}
    \item \textbf{Transportador automatizado:} Velocidad variable 0.5-5 m/min
    \item \textbf{Dosimetría:} Película radiocrómica + dosímetros termoluminiscentes
    \item \textbf{Uniformidad de dosis:} ±10\% en volumen objetivo
    \item \textbf{Capacidad:} 250 millones de pupas por semana
\end{itemize}

\textbf{Blindaje y seguridad}
\begin{itemize}
    \item \textbf{Bunker principal:} Concreto barítico espesor 2.1 m
    \item \textbf{Laberinto de acceso:} Diseño en "L" para atenuación radiación
    \item \textbf{Sistemas de seguridad:} Detectores de radiación + alarmas audibles/visuales
    \item \textbf{Monitoreo personal:} Dosímetros individuales para todo el personal
\end{itemize}
