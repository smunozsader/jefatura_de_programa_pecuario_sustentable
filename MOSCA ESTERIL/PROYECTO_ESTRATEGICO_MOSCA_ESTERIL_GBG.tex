...
Este proyecto estratégico responde a la emergencia sanitaria derivada de brotes activos de Gusano Barrenador del Ganado (\textit{Cochliomyia hominivorax}) detectados a fines de 2024, que resultaron en la suspensión de exportaciones ganaderas a Estados Unidos implementada a inicios de 2025\textsuperscript{16,14}. Los datos del modelo de implementación de Chiapas demuestran capacidad de producción exitosa superior a 4,000 millones de moscas estériles liberadas\textsuperscript{13,20}, respaldando la factibilidad de implementación acelerada en Yucatán con inicio operativo proyectado para el Tercer trimestre de 2026.

\textbf{Análisis de Situación Actual:}
\begin{itemize}
    \item \textbf{Evaluación de impacto económico:} Pérdidas anuales cuantificadas de \$50 millones USD en exportaciones\textsuperscript{17,11}
    \item \textbf{Evaluación de infraestructura:} Capacidad operativa verificada en instalaciones SSY, UADY y SEDER
    \item \textbf{Validación del modelo:} Instalación de Chiapas alcanzando producción de 100M moscas/semana en cronograma de 18 meses\textsuperscript{13,7}
    \item \textbf{Marco de cooperación internacional:} Protocolos de asistencia técnica APHIS-USDA establecidos\textsuperscript{16,14}
\end{itemize}
...
\begin{itemize}
    ...
    \item Composición estandarizada de dieta artificial (40\% sangre bovina, 20\% caseína, 5\% agar, vitaminas)\textsuperscript{13,7}
...
\begin{itemize}
    \item Irradiación gamma de pupas masculinas utilizando fuentes de Cobalto-60\textsuperscript{19,1}
    ...
    \item Preservación de capacidades de vuelo y comportamiento de apareamiento\textsuperscript{19,5}
\end{itemize}

\textbf{3. Metodología de liberación terrestre sistemática}
\begin{itemize}
    \item Densidad de liberación estandarizada: 3,000-5,000 machos estériles por km²\textsuperscript{19,13}
